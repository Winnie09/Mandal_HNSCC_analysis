...
d <- readRDS('/home/whou10/scratch4/whou10/RajMandal/data/christ/lamian_data/plot/pm/plotdata.rds')
...
for (g in names(d)) {
  ...
  pdf(paste0('/home/whou10/scratch4/whou10/RajMandal/data/christ/lamian_data/plot/pm/pdf/',g,'.pdf'),width=4,height=2.3)
